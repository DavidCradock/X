...
namespace X
{
    ...
    public:
        ...
        inline float getAveragedFPSRate(void) { return (float)mdFPSAveragedRate; }

        // Returns computed Frames Per Second current value.
        inline float getFPS(void) { return (float)mdFPS; }

        // Returns computed Frames Per Second averaged value.
        inline float getFPSAveraged(void) { return (float)mdFPSAveraged; }
