...
namespace X
{
	...
	public:
		...
		// May also be asked to resize to the window's dims, multiplied be the SCSettings::getBackbufferScale();
		void bindAsRenderTarget(bool bClearbuffer = true, bool bResizeToScaledWindowDimensions = false, const CColour& backgroundClearColour = CColour(0,0,0,0));
