...
namespace X
{
	...
	public:
		...
		real getSign(const CVector2r& vOther);
		...
		real getAngleRadiansUnsigned(const CVector2r& vOther);
		...
		real getAngleRadiansSigned(const CVector2r& vOther);
		...
		CVector2r getPerpendicular(void);
		...
		CVector2r interpolate(const CVector2r& v1, const CVector2r& v2, real r);
