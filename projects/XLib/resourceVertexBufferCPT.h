...
namespace X
{
	// Resource used by SCResourceManager, a vertex buffer with colour, position and texture coordinates
	class CResourceVertexBufferCPT : public CResourceBase
	{
	public:
		CResourceVertexBufferCPT();
		~CResourceVertexBufferCPT();
