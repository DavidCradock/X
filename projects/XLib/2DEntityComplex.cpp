...
namespace X
{
	...
	void C2DEntityComplex::setPosition(const CVector2r& vPosition)
	{
		C2DEntity* pParentEntity = _findParentEntity();
	...
	void C2DEntityComplex::setScale(real rScaleX, real rScaleY)
	{
		C2DEntity* pParentEntity = _findParentEntity();
	...
	void C2DEntityComplex::setFrameBasedOnDirection(CVector2r vDir)
	{
		C2DEntity* pParentEntity = _findParentEntity();
	...
	void C2DEntityComplex::setRotation(real rRotationDegrees)
	{
		if (rRotationDegrees > 360)
			rRotationDegrees = 360;
		else if (rRotationDegrees < 0.0)
			rRotationDegrees = 0.0;
		_mrParentRotationDegrees = rRotationDegrees;
	}

	void C2DEntityComplex::setRotation(CVector2r vDirection)
	{
		_mrParentRotationDegrees = vDirection.getAngleDegrees360();
	}
}